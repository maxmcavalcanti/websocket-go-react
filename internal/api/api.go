...
import (
	...
	"github.com/maxmcavalcanti/websocket-go-react/internal/store/pgstore/pgstore"
)
...
const (
	...
	MessageKindMessageRemovedReaction = "message_removed_reaction"
...
func (h apiHandler) handleSubscribe(w http.ResponseWriter, r *http.Request) {
	...
	slog.Info("connection closed", "room_id", rawRoomID)
}
...
func (h apiHandler) handleGetRooms(w http.ResponseWriter, r *http.Request) {
	...
	dataRooms, err := json.Marshal(data)
	if err != nil {
		slog.Error("failed to marshal rooms response", "error", err)
		http.Error(w, "internal server error", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleGetRoomMessages(w http.ResponseWriter, r *http.Request) {
	...
	dataMessages, err := json.Marshal(data)
	if err != nil {
		slog.Error("failed to marshal messages response", "error", err)
		http.Error(w, "internal server error", http.StatusInternalServerError)
		return
	}

	w.Header().Set("Content-Type", "application/json")
	w.Write(dataMessages)
}
...
func (h apiHandler) handleRemoveReactFromMessage(w http.ResponseWriter, r *http.Request) {
	...
	go h.notifyClient(Message{
		Kind:   MessageKindMessageRemovedReaction,
		RoomID: rawRoomID,
		Value: MessageMessageReacted{
			ID:            messageID.String(),
			ReactionCount: reactionCount,
...
func (h apiHandler) handleMarkMessageAsAnswered(w http.ResponseWriter, r *http.Request) {
	...
	data, _ := json.Marshal(response{Answered: true})
	w.Header().Set("Content-Type", "application/json")
	w.Write(data)
